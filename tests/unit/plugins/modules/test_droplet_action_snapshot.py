...
class TestDropletActionSnapshotFindDroplet:
    ...
    def test_multiple_droplets_error_message(
        ...
        with patch.object(
            ...
            snapshot_obj.module = mock_module
            snapshot_obj.client = mock_client
            snapshot_obj.name = "test-droplet"
            snapshot_obj.region = "nyc3"
            snapshot_obj.droplet_id = None
            snapshot_obj.snapshot_name = "test-snapshot"

            with pytest.raises(AnsibleFailJson) as exc:
                snapshot_obj.find_droplet()
    ...
    def test_single_droplet_found(
        ...
        with patch.object(
            ...
            result = snapshot_obj.find_droplet()
